const countriesData = [
    ...
    ["Venezuela", "ve", "58"], ["Vietnam (Việt Nam)", "vn", "84"],
...
for (let i = 0; i < countriesData.length; i++) {
    let g = countriesData[i];
    countriesData[i] = {name: g[0], iso2: g[1], dialCode: g[2], priority: g[3] || 0, areaCodes: g[4] || null};
}
 ...
 */
countriesData.getPhoneCode = function(iso2) {
    iso2 = iso2.toLowerCase();
    let countryData = this.find(function (country) {
        return country.iso2 === iso2;
    })
    return countryData.dialCode || '';
}
countriesData.getPhoneCode.bind(countriesData);
 ...
 */
function replacePhoneCode(phoneNumber, currentPhoneCode, newPhoneCode) {
